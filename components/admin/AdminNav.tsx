...
export default function AdminNav({ nav, sesion }: { nav: ItemNav[]; sesion: Sesion | null }) {
  ...
  return (
    <>
      ...
      <header className="flex items-center justify-between border-b border-cielo/10 bg-white p-4 sm:hidden print:hidden">
      ...
      <aside className="hidden w-64 shrink-0 flex-col border-r border-cielo/10 bg-white p-5 sm:flex print:hidden">
