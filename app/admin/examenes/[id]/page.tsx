...
export default function EditarExamen({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function guardarConfig(e: React.FormEvent) {
    ...
    const payload = {
      ...
      mezclarRespuestas: examen.mezclarRespuestas,
      numPreguntasAlAzar: examen.numPreguntasAlAzar,
      escalaCalificacion: examen.escalaCalificacion,
      notaAprobatoria: examen.notaAprobatoria,
      emiteCertificado: examen.emiteCertificado,
