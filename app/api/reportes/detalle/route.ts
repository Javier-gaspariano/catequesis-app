  ...
  for (const it of intentos) {
    ...
    for (const r of it.respuestas) {
      filas.push({
        ...
        RespuestaDada: resumirValorRespuesta(r.pregunta.tipo, r.valorJson, r.pregunta.opciones, r.valorRecuperadoTexto),
        HoraDeLaRespuesta: r.respondidaEn.toLocaleString("es-MX"),
